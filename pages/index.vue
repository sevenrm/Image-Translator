...
async function upload() {
  ...
  if (res.result) {
    ...
    const socket = new WebSocket(
      `${config.public.wsBase}/task/${taskId.value}/event/v1`
    );
  ...
  <div class="flex-1 flex justify-between items-center gap-6">
    <div class="flex-1 flex flex-col min-w-0 h-full">
      ...
      >
        ...
        />
        <div
          class="grid place-items-center w-full h-full rounded-2xl text-zinc-800"
        >
          <div
            v-if="resultUri"
          ...
          >
            ...
            <div class="flex flex-col items-center">
              ...
              <div v-if="taskId" class="text-sm font-mono">
                Task ID: {{ taskId }}
              </div>
              <div v-if="errorId" class="text-sm font-mono">
                Error ID: {{ errorId }}
              </div>
            </div>
            ...
            <div class="flex flex-col gap-2 pointer-events-none">
              ...
              <label class="pointer-events-auto">
                ...
                <div class="mt-1 ml-1 w-54 text-xs">
                  If GPT-3.5 can't process your image, try using other
                  translators!
                </div>
              </label>
          ...
          <div
            v-else
            class="flex flex-col items-center justify-center gap-10vh"
          >
            <div>&nbsp;</div>
            ...
            <div class="flex items-center gap-1">
              <span
                class="px-2 py-1 rounded-full text-xs text-fuchsia-600 font-bold leading-3 bg-fuchsia-100"
              >
                note
              </span>
              <span>
                We are migrating to a new server. If you encounter any issues,
                contact us on
                <a
